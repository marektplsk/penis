...
<div class="form-container max-w-md w-full p-8 bg-white rounded-xl shadow-lg">
    ...
    <form action="{{ route('register') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="name" class="border border-gray-300 rounded-md p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="password" name="password_confirmation" class="border border-gray-300 rounded-md p-3 w-full focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>

        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-md focus:outline-none transition duration-300">Register</button>
    </form>

    <!-- Login Button -->
    <div class="mt-4 text-center">
        <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Already have an account? <span class="font-semibold">Login</span></a>
    </div>
