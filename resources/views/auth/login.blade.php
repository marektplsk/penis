...
<div class="form-container max-w-md w-full p-8 bg-white rounded-xl shadow-lg">
    <h1 class="text-3xl font-bold text-center text-purple-600 mb-6">Login</h1>
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <div class="mb-6 flex items-center">
            <input type="checkbox" name="remember" id="remember" class="mr-3 h-4 w-4 text-purple-500">
            <label for="remember" class="text-sm text-gray-700">Remember Me</label>
        </div>

        <button type="submit" class="w-full bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 rounded-md focus:outline-none transition duration-300">Login</button>
    </form>

    <!-- Register Button -->
    <div class="mt-4 text-center">
        <a href="{{ route('register') }}" class="text-purple-600 hover:text-purple-800 text-sm font-medium">Don't have an account? <span class="font-semibold">Register</span></a>
    </div>
